...
start a Surrogate Optimization. It is generated by using the pySOT_dictionary module.

Information on how each of the components is stored in the dictionary is given below. 
Also more information on how each of the components operates can be found here_.
...
a single "None" entry. This means that this particular class did not have
any default values.

*Note:* In most cases the number of default values is lesser than
